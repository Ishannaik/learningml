...
- [ ] [Paper: ‘Calling on the classical phone’: a distributional model of adjective-noun errors in learners’ English](http://aurelieherbelot.net/resources/papers/coling2016_error_detection_final.pdf)
...
- [ ] [Article: The 3 Deep Learning Frameworks For End-to-End Speech Recognition That Power Your Devices](https://heartbeat.comet.ml/the-3-deep-learning-frameworks-for-end-to-end-speech-recognition-that-power-your-devices-37b891ddc380)
...
- [ ] [Youtube: ML for Audio Study Group](#)
	- [ ] [ML for Audio Study Group - Kick Off](https://www.youtube.com/watch?v=cAviRhkqdnc)
